...
const navItems = [
  ...
  {
    label: "List Guru",
    href: "/dashboard/admin/list-guru",
    icon: (active: boolean) => (
      <svg width="19" height="19" viewBox="0 0 20 20" fill="none">
        <path d="M3 5h14M3 10h10M3 15h7" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" opacity={active ? "1" : ".7"} />
        <circle cx="16" cy="14" r="3" stroke="currentColor" strokeWidth="1.4" opacity={active ? "1" : ".7"} />
        <path d="M16 13v1.5l1 1" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" opacity={active ? "1" : ".7"} />
      </svg>
    ),
  },
  {
    label: "List Siswa",
    href: "/dashboard/admin/list-siswa",
    icon: (active: boolean) => (
      <svg width="19" height="19" viewBox="0 0 20 20" fill="none">
        <path d="M3 5h14M3 10h10M3 15h7" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" opacity={active ? "1" : ".7"} />
        <circle cx="16" cy="15" r="3" stroke="currentColor" strokeWidth="1.4" opacity={active ? "1" : ".7"} />
        <path d="M16 14v1l1 1" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" opacity={active ? "1" : ".7"} />
      </svg>
    ),
  },
  {
      ...
      <div className="px-4 pb-7 pt-4 border-t border-white/10">
        <div className="flex items-center gap-3 px-2 py-2">
          ...
          <div className="flex-1 min-w-0">
            <p className="text-white text-[13.5px] font-bold truncate">Administrator</p>
            <p className="text-white/40 text-[11px] truncate">Admin Sistem</p>
          </div>
          <button
